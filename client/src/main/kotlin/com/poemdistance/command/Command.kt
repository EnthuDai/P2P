package com.poemdistance.command
...
class Command02(): Command(){
    ...
    override fun toArray(): UByteArray {
        ...
        System.arraycopy(ip,0,this.dataArea,0, 4)
        System.arraycopy(Hex.intToBytes(port,false),2,this.dataArea,4,2)
        System.arraycopy(Hex.longToBytes(connectTime),0,dataArea,6,8)
        return super.toArray()
    }
}